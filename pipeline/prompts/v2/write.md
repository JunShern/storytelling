...
Changes from v1: every story now has (1) a short "Before we begin" introduction
that primes listeners on the setting and unfamiliar terms, (2) a real plot with
a story arc, (3) characters who talk to each other in dialogue, and (4) freedom
to use a wider range of moods.
...
- **An introduction first.** Before the story, write a "Before we begin" section
  of roughly 60–130 words — about thirty seconds read aloud, in a warm,
  ...
  the plot.
- **Length:** 900–1,200 words for the story itself (the introduction is on top
  of this) — a 5–10 minute read-aloud at a gentle pace.
